...
modelo_final = ChatPromptTemplate.from_messages(
    [
        ...
        ("ai","Restaurantes que voce não pode perder: {restaurantes}"),
        ("ai","Atividades e locais culturaisrecomendados: {locais_culturais}"),
        ("system","Combine as informações das informações anteriores em 2 parágrafos coerentes")
    ]
)
